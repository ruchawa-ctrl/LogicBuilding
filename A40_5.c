...
// Description       : Used to count the number of elements lesser than a given number in the Linked
// Parameters       : First pointer 
// Return Value     : int 
// 
///////////////////////////////////////////////////////////////////
...
{ 
    ...
    iRet = CountLess(First, 20);
    printf("Number of elements lesser than 20: %d\n", iRet);
